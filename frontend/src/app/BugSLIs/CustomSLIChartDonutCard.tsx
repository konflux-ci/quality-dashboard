    ...
    return (
        <Card style={{ width: '100%', height: '100%', textAlign: 'center' }}>
            <CardTitle>
                ...
                {props.title == 'Triage Time Bug SLI' && (
                    help(<div><b>Number of untriaged bugs that do not meet Triage Time Bug SLO.</b> <br /><br /><b>Red SLI</b>: Priority undefined for more than 2 days on untriaged bugs. <br /><br /> <b>Yellow SLI</b>: Priority undefined for more than 1 day on untriaged bugs.</div>)
                )}
            </CardTitle>
