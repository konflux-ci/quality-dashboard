        ...
        {props.workflows.map((workf) => {
          ...
          return (
            <Tr key={workflow.workflow_name || ''}>
              ...
              <Td dataLabel={columnNames.badge}>
                <img src={workflow.badge_url}></img>
              </Td>
              <Td dataLabel={columnNames.html_url}>
                <a href={workflow.html_url} target="blank" rel="noopener noreferrer">
                  <ExternalLinkAltIcon>Link</ExternalLinkAltIcon>Go to job
                </a>
              </Td>
            </Tr>
          );
