...
func (e ProwSuitesEdges) ProwSuitesOrErr() (*Repository, error) {
	if e.loadedTypes[0] {
		if e.ProwSuites == nil {
			// The edge prow_suites was loaded in eager-loading,
			// but was not found.
...
func (*ProwSuites) scanValues(columns []string) ([]interface{}, error) {
...
func (ps *ProwSuites) assignValues(columns []string, values []interface{}) error {
