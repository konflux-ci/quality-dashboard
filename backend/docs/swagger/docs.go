                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/jira.ProjectListSimplified"
                            }
                        }
                    }
                }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/plugins.TeamPluginRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "db.Bugs": {
            ...
            "properties": {
                ...
                "jira_key": {
                    "description": "JiraKey holds the value of the \"jira_key\" field.",
                    "type": "string"
                },
                "priority": {
                ...
                "project_key": {
                    "description": "ProjectKey holds the value of the \"project_key\" field.",
                    "type": "string"
                },
                "resolution_time": {
                    "description": "ResolutionTime holds the value of the \"resolution_time\" field.",
                    "type": "number"
                },
                "resolved": {
                    "description": "Resolved holds the value of the \"resolved\" field.",
                    "type": "boolean"
                },
                "resolved_at": {
        ...
        "db.BugsEdges": {
            ...
            "properties": {
                "bugs": {
                    "description": "Bugs holds the value of the bugs edge.",
                    "allOf": [
                        {
                            "$ref": "#/definitions/db.Teams"
                        }
        ...
        "db.CodeCov": {
            ...
            "properties": {
                "average_retests_to_merge": {
                    "description": "AverageRetestsToMerge holds the value of the \"average_retests_to_merge\" field.",
                    "type": "number"
                },
                "coverage_percentage": {
                ...
                "coverage_trend": {
                    "description": "CoverageTrend holds the value of the \"coverage_trend\" field.",
                    "type": "string"
                },
                "edges": {
        ...
        "db.Failure": {
            ...
            "properties": {
                "edges": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/db.FailureEdges"
                        }
                    ]
                },
                "error_message": {
                ...
                "jira_status": {
                    "description": "JiraStatus holds the value of the \"jira_status\" field.",
                    "type": "string"
                }
            }
        },
        "db.FailureEdges": {
            ...
            "properties": {
                "failures": {
                    "description": "Failures holds the value of the failures edge.",
                    "allOf": [
                        {
                            "$ref": "#/definitions/db.Teams"
                        }
        ...
        "db.Plugins": {
            ...
            "properties": {
                ...
                "edges": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/db.PluginsEdges"
                        }
                    ]
                },
                "id": {
                ...
                "logo": {
                    "description": "Logo holds the value of the \"logo\" field.",
                    "type": "string"
                },
                "name": {
        ...
        "db.ProwJobs": {
            ...
            "properties": {
                "build_error_logs": {
                    "description": "BuildErrorLogs holds the value of the \"build_error_logs\" field.",
                    "type": "string"
                },
                "ci_failed": {
                ...
                "e2e_failed_test_messages": {
                    "description": "E2eFailedTestMessages holds the value of the \"e2e_failed_test_messages\" field.",
                    "type": "string"
                },
                "edges": {
                ...
                "suites_xml_url": {
                    "description": "SuitesXMLURL holds the value of the \"suites_xml_url\" field.",
                    "type": "string"
                },
                "tests_count": {
        ...
        "db.PullRequests": {
            ...
            "properties": {
                ...
                "edges": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/db.PullRequestsEdges"
                        }
                    ]
                },
                "id": {
                ...
                "merge_commit": {
                    "description": "MergeCommit holds the value of the \"merge_commit\" field.",
                    "type": "string"
                },
                "merged_at": {
                    "description": "MergedAt holds the value of the \"merged_at\" field.",
                    "type": "string"
                },
                "number": {
                ...
                "pr_id": {
                    "description": "PrID holds the value of the \"pr_id\" field.",
                    "type": "string"
                },
                "repository_name": {
                    "description": "RepositoryName holds the value of the \"repository_name\" field.",
                ...
                "repository_organization": {
                    "description": "RepositoryOrganization holds the value of the \"repository_organization\" field.",
                    "type": "string"
                },
                "retest_before_merge_count": {
                    "description": "RetestBeforeMergeCount holds the value of the \"retest_before_merge_count\" field.",
                    "type": "number"
                },
                "state": {
                    "description": "State holds the value of the \"state\" field.",
        ...
        "db.PullRequestsEdges": {
            "type": "object",
            "properties": {
                "prs": {
                    "description": "Prs holds the value of the prs edge.",
                    "allOf": [
                        {
                            "$ref": "#/definitions/db.Repository"
                        }
        ...
        "db.RepositoryEdges": {
            ...
            "properties": {
                ...
                "prs": {
                    ...
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/db.PullRequests"
                    }
                },
                "repositories": {
        ...
        "db.Teams": {
            ...
            "properties": {
                ...
                "jira_keys": {
                    "description": "JiraKeys holds the value of the \"jira_keys\" field.",
                    "type": "string"
                },
                "team_name": {
        ...
        "db.TeamsEdges": {
            ...
            "properties": {
                ...
                "failures": {
                    ...
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/db.Failure"
                    }
                },
                "plugins": {
                    "description": "Plugins holds the value of the plugins edge.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/db.Plugins"
                    }
